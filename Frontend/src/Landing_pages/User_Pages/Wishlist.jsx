    ...
    <>
      ...
      <main className="pt-28 px-6 max-w-7xl mx-auto">
        ...
        <div className="mt-20 flex gap-6 overflow-x-auto">
          <RecommendedCard title="Minimalist Studio" price="550" img="..." />
          <RecommendedCard title="Mountain Cabin" price="720" img="..." />
          <RecommendedCard title="Luxury Penthouse" price="1050" img="..." />
        </div>
      </main>
